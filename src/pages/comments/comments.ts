...
export class CommentsPage {
  ...
  carregarComentarios(){
    ...
    var link = 'http://18.217.102.194/app/comments/puxarComentario';
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            let link = 'http://18.217.102.194/app/comments/deletarComentario';
  ...
  enviarComentario(){
    ...
    var link = 'http://18.217.102.194/app/comments/salvarComentario';
