...
export class FeedPage {
  ...
  getQtdNotificacoes() {
    ...
    var link = 'http://18.217.102.194/app/usuarios/notificacoes_qtd';
  ...
  enviarEstrelas(stars, anuncio) {
    ...
    var link = 'http://18.217.102.194/app/anuncios/stars';
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: () => {
              ...
              var link = 'http://18.217.102.194/app/post/denunciar';
  ...
  opts(myEvent, post) {
    ...
    popover.onDidDismiss(popoverData => {
      if(popoverData == "denunciar") {
        ...
        var link = 'http://18.217.102.194/app/anuncios/denunciarAnuncio';
  ...
  notificacoes(myEvent) {
    ...
    popover.onDidDismiss(popoverData => {
      ...
      var link = 'http://18.217.102.194/app/usuarios/limparNotificacoes';
  ...
  seguidores() {
    ...
    var link = 'http://18.217.102.194/app/anuncios/seguidores';
  ...
  loadFeed(lat, long, infiniteScroll) {
    ...
    var link = 'http://18.217.102.194/app/anuncios/puxarTodos';
